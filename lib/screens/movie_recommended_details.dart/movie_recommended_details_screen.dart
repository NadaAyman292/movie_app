...
class MovieRecommendedDetailsScreen extends StatelessWidget {
  static const String routeName = "movieRecommendedDetailsScreen";
  const MovieRecommendedDetailsScreen({super.key});
